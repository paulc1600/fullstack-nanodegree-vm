...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter(name = 'Pizza Palace').first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter(name = 'Urban Burger').first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter(name = 'Super Stir Fry').first()
RestProperty2 = RestProperties(street="2254 Perine Street", city="Alexandria", state="VA", zip="22370", phone="703-806-8377", review_rating="4.0", rest_photo_file="FD2_Restaurant.jpg",
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter(name = 'Panda Garden').first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter(name = 'Thyme for That Vegetarian Cuisine').first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter(name = "Tony\'s Bistro").first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter(name = "Uncle Joe\'s Diner").first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter(name = 'Pelican Bay Oyster House').first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter(name = "Bill\'s House of Gator").first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter(name = 'Ming Wang Wok Palace').first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter(name = 'Boca Do Papa').first()
