...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter_by(Restaurant.name = 'Pizza Palace').first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter_by(Restaurant.name = 'Urban Burger').first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter_by(Restaurant.name = 'Super Stir Fry').first()
RestProperty2 = RestProperties(street="2254 Perine Street", city="Alexandria", state="VA", zip="22370", phone="703-806-8377", review_rating="4.0", rest_photo_file="FD2_Restaurant.jpg",
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter_by(Restaurant.name = 'Panda Garden').first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter_by(Restaurant.name = 'Thyme for That Vegetarian Cuisine').first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter_by(Restaurant.name = "Tony\'s Bistro").first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter_by(Restaurant.name = "Uncle Joe\'s Diner").first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter_by(Restaurant.name = 'Pelican Bay Oyster House').first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter_by(Restaurant.name = "Bill\'s House of Gator").first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter_by(Restaurant.name = 'Ming Wang Wok Palace').first()
...
# --------------------------------------------------------------------------------
restaurant1 = session.query(Restaurant).filter_by(Restaurant.name = 'Boca Do Papa').first()
